package com.example.libreriainsertar.EntidadesLibreria;

import java.io.Serializable;

public class Mascota{
    private String id,id_cliente,nombre_mascota,raza,sexo,f_nac,foto;
    public Mascota(String id, String id_cliente, String nombre_mascota, String raza, String sexo, String f_nac, String foto){
